...
1. Project Milestone 2 grading will take until next Monday.
1. Project Peer Reviews are due [December 4]
1. Problem Set 4 is due [December 4]
1. Project Presentations will be held [December 12]
1. Project Milestone 3 is due [December 13]

---

### Beautiful Visualizations

Figure from [*Genes mirror geography within Europe*](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2735096/).

.center[
<img src="figures/nihms132060f1.jpg" width=500/>
]
...
* We will work through [Living Wages] in the exercise sheet.

* [Code]: [https://go.wisc.edu/a18ij6](https://go.wisc.edu/a18ij6)
* [Whiteboard]: [https://go.wisc.edu/gz8yo4](https://go.wisc.edu/gz8yo4)
...
1. Project Milestone 3 is due [December 13]
1. Project Presentations will be held [December 12]
  * Each team has 9 minutes to present. 
  * The team order is in the updated project description.
  * Send me your slides by 7am that day.
...
1. Preprocessing steps in PCA and topic models.
1. For topic models, what exactly is discrepancy? How is it calculated?

---

### Exercise Review

`step_normalize()` makes sure that all columns have mean 0 and variance 1. This
makes sure no high-variance columns dominate the PCA.
...
We increment the `chapter` column every time we encounter the word "chapter" in
the `text` column. Unite defines a new column called document.
...
`discrepancy` tells whether a word has different probabilities across topics.
...
* Whiteboard: [https://go.wisc.edu/92v2p2](https://go.wisc.edu/92v2p2)
* [Link]: [https://go.wisc.edu/i0c9j8](https://go.wisc.edu/i0c9j8)

Warm Up: Lecture notes 12.1 discussed `beta` and `gamma` matrices. How should we
interpret the rows and columns of these matrices?
...
* With your team, work through either [Interpreting UMAP] or [Interpreting Topic
Models] in the exercise sheet.

* Add your answers to this document: [go.wisc.edu/c7o194](go.wisc.edu/c7o194)
...
1. Project Presentations will be held [December 12]
  ...
  * The team order is in the updated project description.
  * Send me your slides by 7am that day. 
  * I want people to have a chance to hear about your projects -- invite anyone you think might be interested.

---

### My Talk

I am giving the Stat Seminar (Wednesday 4pm, SMI 133). There will lots of
visualization.

Code: https://go.wisc.edu/q43ol3
...
* Code: [https://go.wisc.edu/mymrz3](https://go.wisc.edu/mymrz3)
* Whiteboard: [https://go.wisc.edu/hrlk14](https://go.wisc.edu/hrlk14)

---

### In-Class Discussion

* Work through [Skimming a Paper] in the exercise sheet. Pick one of the papers
linked in the google doc below.

* Share your team's responses here: [https://go.wisc.edu/w9074r](https://go.wisc.edu/w9074r)
...
.center[
<img src="https://imgs.xkcd.com/comics/compact_graphs.png" width=600/>
]
...
Let's see how we might move beyond "single file" javascript visualization.

Whiteboard: [https://go.wisc.edu/1j064x](https://go.wisc.edu/1j064x)

Code: [https://go.wisc.edu/td1wc5](https://go.wisc.edu/td1wc5)

Repository: [https://go.wisc.edu/91t2al](https://go.wisc.edu/91t2al)
...
Example themes: [https://go.wisc.edu/xstzsx](https://go.wisc.edu/xstzsx)

---

### Reflection Notes

I'll keep all the resources public at:  [https://krisrs1128.github.io/LSLab/teaching/](https://krisrs1128.github.io/LSLab/teaching/)

* [Notes](https://krisrs1128.github.io/stat992_f23/website/docs/index.html/)
* [Code examples (Github)](https://github.com/krisrs1128/stat992_f23)
* [Recordings (Youtube)](https://www.youtube.com/playlist?list=PLhax_7Mawcfk1GEl_vOg7cE_vtRTsqMWw)

---

### Reflection Notes

1. Data visualization is a skill. It requires more than just knowledge -- it
requires practice.

1. If in the future...

  * You have questions about data visualization
  
  * You want to share a cool visualization you made

  ... do please reach out.

1. Where are we in the history of Data Visualization? ([book](https://datavis.ca/papers/hbook.pdf) by Michael Friendly)

---

### The Golden Age of Data Visualization: Minard (1844)

.center[
<img src="https://upload.wikimedia.org/wikipedia/commons/f/f8/Tableau_figuratif_du_mouvement_commercial_du_Canal_du_centre_en_1844.jpg" width=720/>
]

---

### The Golden Age of Data Visualization: Nightingale (1859)

.center[
<img src="https://uwmadison.box.com/shared/static/c79fbmfc3mff9ota1tzxtvv4gp7e3pul.jpeg" width=700/>
]

---

### The Golden Age of Data Visualization: Galton (1863)

.center[
<img src="https://uwmadison.box.com/shared/static/ar82ax7hcatpy99iz2w6opkzl4cdvv2y.jpeg" width=650/>
]

---

### The Golden Age of Data Visualization: Cheysson (1884)

.center[
<img src="https://upload.wikimedia.org/wikipedia/commons/f/f1/Exp%C3%A9ditions_de_voyageurs_et_de_marchandises.png?1619305371810" width = 400/>
]
...
[https://go.wisc.edu/a4656q](https://go.wisc.edu/a4656q)

* Prompt 1: Interview Preparation
* Prompt 2: Advice for new students
* Prompt 3: What and now what?
